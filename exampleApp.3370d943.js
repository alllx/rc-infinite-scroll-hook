...
},{"./cjs/react-dom.development.js":"../../node_modules/react-dom/cjs/react-dom.development.js"}],"../../src/throttle.ts":[function(require,module,exports) {
"use strict";
...
},{}],"../../src/useInfiniteScroll.ts":[function(require,module,exports) {
"use strict";
...
var useInfiniteScroll = function useInfiniteScroll(containerRef, fetchItems, triggerFetchPos) {
  if (triggerFetchPos === void 0) {
    triggerFetchPos = 300;
  }
...
},{"react":"../../node_modules/react/index.js","./throttle":"../../src/throttle.ts"}],"../../node_modules/parcel-bundler/src/builtins/bundle-url.js":[function(require,module,exports) {
var bundleURL = null;
...
},{"./bundle-url":"../../node_modules/parcel-bundler/src/builtins/bundle-url.js"}],"exampleApp.scss":[function(require,module,exports) {
var reloadCSS = require('_css_loader');

module.hot.dispose(reloadCSS);
module.hot.accept(reloadCSS);
},{"_css_loader":"../../node_modules/parcel-bundler/src/builtins/css-loader.js"}],"loadingSpinner.scss":[function(require,module,exports) {
var reloadCSS = require('_css_loader');

module.hot.dispose(reloadCSS);
module.hot.accept(reloadCSS);
},{"_css_loader":"../../node_modules/parcel-bundler/src/builtins/css-loader.js"}],"LoadingSpinner.tsx":[function(require,module,exports) {
"use strict";
...
var LoadingSpinner = function LoadingSpinner(props) {
  return props.loading ? react_1.default.createElement("div", {
...
},{"react":"../../node_modules/react/index.js","./loadingSpinner.scss":"loadingSpinner.scss"}],"exampleApp.tsx":[function(require,module,exports) {
"use strict";
...
var useInfiniteScroll_1 = __importDefault(require("../../src/useInfiniteScroll"));
...
var App = function App() {
  ...
  var isLoadingMore = useInfiniteScroll_1.default(containerRef, getItems)[0];

  var noMoreItems = function noMoreItems() {
    return items.length > 1000;
  };

  function createItems(length, count) {
    if (length === void 0) {
      length = 20;
    }
    ...
    return Array.from({
      ...
      return "Item #" + (count ? i + count : i);
    });
  }

  function loadMoreItems() {
    setItems(items.concat(createItems(20, items.length)));
  }

  function getItems() {
    return !noMoreItems() ? new Promise(function (res) {
      setTimeout(function () {
        return res(loadMoreItems());
      }, 2000);
    }) : Promise.resolve();
  }
  ...
  }, react_1.default.createElement("h1", null, "Infinite scroll example:"), react_1.default.createElement("div", {
  ...
  }), isLoadingMore && !noMoreItems() && react_1.default.createElement("div", {
...
},{"react":"../../node_modules/react/index.js","react-dom":"../../node_modules/react-dom/index.js","../../src/useInfiniteScroll":"../../src/useInfiniteScroll.ts","./exampleApp.scss":"exampleApp.scss","./LoadingSpinner":"LoadingSpinner.tsx"}],"../../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
...
},{}]},{},["../../node_modules/parcel-bundler/src/builtins/hmr-runtime.js","exampleApp.tsx"], null)
//# sourceMappingURL=/exampleApp.3370d943.js.map